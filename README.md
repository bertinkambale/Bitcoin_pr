...
# 📖 Bitcoin_pr <a name="about-project"></a>

**Bitcoin_pr** is a.web site that show you how you can buy some bitcoin and to get money back..
...
- [Live Demo Link](C:\Users\Bertin Kambale\Documents\Microverse\Module1\Bitcoin_pr)
...
```sh
  cd my-folder
   git clone  git@github.com:bertinkambale/Bitcoin_pr.git
```
...
I would like to thanks caleb and my teams for inspired my codebase
